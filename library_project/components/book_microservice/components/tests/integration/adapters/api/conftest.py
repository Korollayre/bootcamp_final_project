...
def book_service_for_controllers(
    ...
    book_service_for_controllers.check_active_book = Mock(
        return_value=booked_book
    )
    book_service_for_controllers.check_bought_book = Mock(
        return_value=[bought_book]
    )
    ...
    book_service_for_controllers.check_by_user = Mock(
...
def client(book_service_for_controllers):
    app = api.create_app(books_service=book_service_for_controllers, )
